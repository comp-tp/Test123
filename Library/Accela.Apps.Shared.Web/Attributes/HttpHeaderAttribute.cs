...
namespace Accela.Apps.Shared.Web.Attributes
{
    ...
    public class HttpHeaderAttribute : ActionFilterAttribute
    {
        ...
        {
            if (filterContext != null && filterContext.HttpContext != null && filterContext.HttpContext.Response != null && filterContext.HttpContext.Response.StatusCode == (int)HttpStatusCode.OK)
            {
