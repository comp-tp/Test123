...
{
    [TestFixture]
    public class PubSubServiceTestForAzureSB
    {
        private static string _endpointConnectionString = "Endpoint=sb://constructpubsubpoc.servicebus.windows.net/;SharedAccessKeyName=pubsubpoc;SharedAccessKey=eBG6+RyV+zccIID+9MxrKWRwi8GCBbJwwfbFegpEi2w=";
        ...
        [Test]
        public async void PublishAndSubscriberThruervieBus_ShouldSuccess()
        {
