...
namespace Accela.Apps.Apis.WSModels.ASIs
{
    ...
    public class WSAdditionalItem : WSASIColumn
    {
        ...
        public static WSAdditionalItem FromWSASIItem(WSASIItem wsASIItem)
        {
            if (wsASIItem != null)
            {
                var wsAdditionalItem = new WSAdditionalItem()
                {
                ...
                {
                    wsAdditionalItem.Enumerations = new List<WSEnumeration>();
                    wsASIItem.Enumerations.ForEach(item => wsAdditionalItem.Enumerations.Add(new WSEnumeration
                    {
                        Id = item.Id,
        ...
        public static List<WSAdditionalItem> FromWSASIItems(List<WSASIItem> wsASIItems)
        {
            var wsAdditionalItems = new List<WSAdditionalItem>();
            if (wsASIItems != null)
            {
