...
namespace Accela.Apps.Apis.WSModels.Assets
{
    ...
    public class WSAssetCA : WSIdentifierBase
    {
        [DataMember(Name = "asset", EmitDefaultValue = false, Order = 3)]
        public WSCAAsset Asset { get; set; }
        ...
        [DataMember(Name = "observations", EmitDefaultValue = false, Order = 15)]
        ...
        public static WSAssetCA FromEntityModel(AssetCAModel assetCAModel)
        {
            ...
            if (assetCAModel != null)
            {
                ...
                wsAssetCA.Asset = WSCAAsset.FromEntityModel(assetCAModel.CAAsset);
