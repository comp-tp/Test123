...
{
    [DataContract]
    public class WSStaffPerson : WSDataModel
    {
        /// <summary>
        ...
        public static WSStaffPerson FromEntityModel(StaffPersonModel staffPersonModel)
        {
            if (staffPersonModel != null)
            {
                return new WSStaffPerson
                {
        ...
        public static StaffPersonModel ToEntityModel(WSStaffPerson wsStaffPerson)
        {
