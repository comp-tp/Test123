...
namespace Accela.Apps.Apis.WSModels.ASIs.InspectorApp
{
    ...
    public class WSInspectorAppASI
    {
        /// <summary>
        ...
        public List<WSInspectorAppASISubGroup> SubGroups { get; set; }
        ...
        public static AdditionalGroupModel ToEntityModel(WSInspectorAppASI wsASI)
        {
            if (wsASI != null)
            {
                return new AdditionalGroupModel()
                {
                    ...
                    SubGroups = WSInspectorAppASISubGroup.ToEntityModels(wsASI.SubGroups)
                };
            }
            return null;
        }

        public static List<AdditionalGroupModel> ToEntityModels(List<WSInspectorAppASI> wsASIs)
        {
