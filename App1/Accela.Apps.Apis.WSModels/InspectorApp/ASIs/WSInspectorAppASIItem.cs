...
namespace Accela.Apps.Apis.WSModels.ASIs.InspectorApp
{
    ...
    public class WSInspectorAppASIItem : WSInspectorAppASIColumn
    {
        ...
        public static AdditionalItemModel ToEntityModel(WSInspectorAppASIItem wsASIItem)
        {
            if (wsASIItem != null)
            {
        ...
        public static List<AdditionalItemModel> ToEntityModels(List<WSInspectorAppASIItem> wsASIItems)
        {
