...
namespace Accela.Apps.Apis.WSModels.ASIs.InspectorApp
{
    ...
    public class WSInspectorAppASIValueModel : WSEntityState
    {
        /// <summary>
        ...
        public static AdditionalValueModel ToEntityModel(WSInspectorAppASIValueModel asiValueModel)
        {
        ...
        public static List<AdditionalValueModel> ToEntityModels(List<WSInspectorAppASIValueModel> asiValueModels)
        {
