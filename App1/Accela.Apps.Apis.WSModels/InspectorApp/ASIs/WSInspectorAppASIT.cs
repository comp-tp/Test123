...
namespace Accela.Apps.Apis.WSModels.ASIs.InspectorApp
{
    ...
    public class WSInspectorAppASIT
    {
        /// <summary>
        ...
        public List<WSInspectorAppASIColumn> Columns
        {
            get;
            set;
        }
        ...
        public List<WSInspectorAppDrillDownSeries> DrillDownSeries
        {
            get; 
            set;
        } 
        ...
        public static AdditionalTableModel ToEntityModel(WSInspectorAppASIT wsASIT)
        {
            if (wsASIT != null)
            {
                return new AdditionalTableModel()
                {
                    ...
                    Columns = WSInspectorAppASIColumn.ToEntityModels(wsASIT.Columns),
                    Rows = WSInspectorAppASIRow.ToEnityModels(wsASIT.Rows)
        ...
        public static List<AdditionalTableModel> ToEntityModels(List<WSInspectorAppASIT> wsASITs)
        {
