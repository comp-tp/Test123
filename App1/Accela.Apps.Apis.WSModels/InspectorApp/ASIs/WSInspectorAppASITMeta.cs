...
namespace Accela.Apps.Apis.WSModels.ASIs.InspectorApp
{
    ...
    public class WSInspectorAppASITDescribe
    {
        /// <summary>
        ...
        public static WSInspectorAppASITDescribe FromWSASIT(WSInspectorAppASIT wsasit)
        {
            WSInspectorAppASITDescribe wsasitDescribe = null;
            if (wsasit != null)
            {
                wsasitDescribe = new WSInspectorAppASITDescribe();
        ...
        public static List<WSInspectorAppASITDescribe> FromWSASITs(List<WSInspectorAppASIT> wsasits)
        {
            var wsasitDescribes = new List<WSInspectorAppASITDescribe>();
