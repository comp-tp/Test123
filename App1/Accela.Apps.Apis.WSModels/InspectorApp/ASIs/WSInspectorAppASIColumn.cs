...
namespace Accela.Apps.Apis.WSModels.ASIs.InspectorApp
{
    ...
    public class WSInspectorAppASIColumn : WSEntityState
    {
        /// <summary>
        ...
        public List<WSInspectorAppEnumeration> Enumerations
        {
            get;
            set;
        }
        ...
        public static AdditionalColumnModel ToEntityModel(WSInspectorAppASIColumn wsASIColumn)
        {
            if (wsASIColumn != null)
            {
        ...
        public static List<AdditionalColumnModel> ToEntityModels(List<WSInspectorAppASIColumn> wsASIColumns)
        {
    ...
    [DataContract]
    public class WSInspectorAppEnumeration
    {
        [DataMember(Name = "id", EmitDefaultValue = false)]
