...
{
    [DataContract]
    public class WSInspectorAppCompactAddress : WSDataModel
    {
        /// <summary>
        ...
        public static AddressModel ToEntityModel(WSInspectorAppCompactAddress wsModel)
        {
            if (wsModel == null)
            {
                return null;
        ...
        public static List<AddressModel> ToEntityModels(List<WSInspectorAppCompactAddress> wsModels)
        {
        ...
        /// <returns>the entity model.</returns>
        public static WSInspectorAppCompactAddress FromEntityModel(AddressModel entityModel)
        {
            if (entityModel == null)
            {
                return null;
            ...
            var result = new WSInspectorAppCompactAddress()
            {
        ...
        public static List<WSInspectorAppCompactAddress> FromEntityModels(List<AddressModel> addressModels)
        {
            if (addressModels != null && addressModels.Count > 0)
            {
                var wsAddressList = new List<WSInspectorAppCompactAddress>();
