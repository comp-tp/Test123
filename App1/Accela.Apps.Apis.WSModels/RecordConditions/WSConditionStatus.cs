...
namespace Accela.Apps.Apis.WSModels.RecordConditions
{
    ...
    public class WSConditionStatus : WSIdentifierBase
    {
        ...
        /// </summary>
        /// <param name="wsConditionStatus">WSConditionStatus.</param>
        /// <returns>ConditionStatusModel.</returns>
        public static ConditionStatusModel ToEntityModel(WSConditionStatus wsConditionStatus)
        {
        ...
        public static WSConditionStatus FromEntityModel(ConditionStatusModel entityModel)
        {
            if (entityModel == null)
            {
                return null;
            ...
            var result = new WSConditionStatus()
            {
