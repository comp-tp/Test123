...
namespace Accela.Apps.Apis.WSModels.Records
{
    ...
    public class WSRecordBase : WSDataModel
    {
        /// <summary>
        /// UID separator
        /// </summary>
        ...
        public WSStaffPerson StaffPerson { get; set; }        
        ...
        public static WSRecordBase FromEntityModel(RecordModel record)
        {
            if (record != null)
            {
                return new WSRecordBase()
                {
        ...
        public static void ToEntityModel(RecordModel recordModel, WSRecordBase wsRecord)
        {
